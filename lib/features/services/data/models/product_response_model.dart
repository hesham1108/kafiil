...
class ServiceResponseModel {
  ...
  ServiceResponseModel({this.products});
  ...
  ProductModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['required_product_ids'] != null) {
      ...
      json['required_product_ids'].forEach((v) {
        requiredProductIds!.add(v.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (requiredProductIds != null) {
      data['required_product_ids'] =
          requiredProductIds!.map((v) => jsonEncode(v)).toList();
    }
    ...
    if (roleIds != null) {
      data['role_ids'] = roleIds!.map((v) => jsonEncode(v)).toList();
    }
    if (discountIds != null) {
      data['discount_ids'] = discountIds!.map((v) => jsonEncode(v)).toList();
    }
    if (storeIds != null) {
      data['store_ids'] = storeIds!.map((v) => jsonEncode(v)).toList();
    }
    if (manufacturerIds != null) {
      data['manufacturer_ids'] =
          manufacturerIds!.map((v) => jsonEncode(v)).toList();
    }
    if (images != null) {
    ...
    if (associatedProductIds != null) {
      data['associated_product_ids'] =
          associatedProductIds!.map((v) => jsonEncode(v)).toList();
    }
    if (tags != null) {
      data['tags'] = tags!.map((v) => jsonEncode(v)).toList();
    }
  ...
  Attributes.fromJson(Map<String, dynamic> json) {
    ...
    if (json['attribute_values'] != null) {
      ...
      json['attribute_values'].forEach((v) {
        attributeValues!.add(jsonDecode(v));
      });
    }
    id = json['id'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (attributeValues != null) {
      data['attribute_values'] =
          attributeValues!.map((v) => jsonEncode(v)).toList();
    }
    data['id'] = id;
    return data;
  }
